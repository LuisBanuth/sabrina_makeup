                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ route('admin.products.index') }}">Todos os produtos</a>
                                    <a class="nav-link" href="{{ route('admin.products.create') }}">Criar novo</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseService" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ route('admin.services.index') }}">Todos os serviços</a>
                                    <a class="nav-link" href="{{ route('admin.services.create') }}">Criar novo</a>
                                </nav>
                            </div>
