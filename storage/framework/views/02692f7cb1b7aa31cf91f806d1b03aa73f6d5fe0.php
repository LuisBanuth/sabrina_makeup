                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="<?php echo e(route('admin.products.create')); ?>">Criar novo</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseService" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="<?php echo e(route('admin.services.create')); ?>">Criar novo</a>
                                </nav>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\sabrina\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>